...
path=$(find ~/Library/Developer/Xcode/DerivedData/IOSChat-*/Build/Products/Debug-iphonesimulator -name "IOSChat.app" | head -n 1)
echo "${path}"
...
xcrun simctl launch "$line" com.janduda.IOSChat # Launch .app using its bundle at simulator with identifier hold by $line var
done
